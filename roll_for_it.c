...
void initialiser_carte(carte cards[NB_CARTES]){
    ...
    //avant derniere carte
    cards[13].points = 5;
    cards[13].id = 13;
    cards[13].taille_combinaison = 3;
    cards[13].combinaison[0] = 2;
    cards[13].combinaison[1] = 6;
    cards[13].combinaison[2] = 6;

    //derniere carte
    cards[14].points = 5;
    cards[14].id = 14;
    cards[14].taille_combinaison = 3;
    cards[14].combinaison[0] = 1;
    cards[14].combinaison[1] = 4;
    cards[14].combinaison[2] = 4;
}
